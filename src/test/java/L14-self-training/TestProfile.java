...
public class TestProfile {
    ...
    @AfterMethod
        ...
        public void testFollowUser() {
            ...
            WebElement userToFollow = driver.findElement(By.xpath("//a[contains(text(), \"TestUserUserUserUser\")]"));
            ...
            System.out.println("This user is already followed");
                ...
                wait.until(ExpectedConditions.textToBe(By.xpath("//h2[contains(text(), \"stanig1\")]"), "stanig1"));
                ...
                WebElement followedUser = driver.findElement(By.xpath("//a[contains(text(), \"TestUserUserUserUser\")]"));
